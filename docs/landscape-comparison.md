...
| **rustscenic** | **4** | — | GitHub Release wheels and `pip install git+...@v0.3.5` succeed on Python 3.10–3.13, Linux + macOS, x86_64 + aarch64. Four runtime deps: numpy, pandas, pyarrow, scipy. PyPI name publish is pending trusted-publisher setup. |
