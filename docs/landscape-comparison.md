...
| **rustscenic** | **5** | — | `pip install rustscenic` (PyPI) on Python 3.10–3.13, with Linux + macOS x86_64/aarch64 wheels today and Windows x64 covered by the release workflow for the next release. Five runtime deps: numpy, pandas, pyarrow, scipy, anndata. |
