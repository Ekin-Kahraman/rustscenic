...
| [Ekin-Kahraman/rustscenic](https://github.com/Ekin-Kahraman/rustscenic) | n/a | v0.4.5 (2026-05-16) | 2026-05-16 |
...
| **rustscenic** | **5** | n/a | `pip install rustscenic` (PyPI) on Python 3.10 to 3.13, with Linux, macOS and Windows x64 wheels in the v0.4.5 release. Five runtime deps: numpy, pandas, pyarrow, scipy, anndata. |
