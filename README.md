...
![RustScenic benchmark memory and runtime figure](site_docs/assets/rustscenic-memory-scale.svg)

This figure is generated by `validation/figures/make_benchmark_visuals.py` from
committed validation rows. The 100k and 200k rows are synthetic scale proofs;
the legacy SCENIC+ >40 GB row is a reported baseline, not a controlled
