...
pip install git+https://github.com/Ekin-Kahraman/rustscenic@v0.3.1

# Or install a prebuilt wheel from the v0.3.0 GitHub Release for your platform:
# macOS Apple Silicon:
pip install https://github.com/Ekin-Kahraman/rustscenic/releases/download/v0.3.1/rustscenic-0.3.1-cp310-abi3-macosx_11_0_arm64.whl
# Linux x86_64:
pip install https://github.com/Ekin-Kahraman/rustscenic/releases/download/v0.3.1/rustscenic-0.3.1-cp310-abi3-manylinux_2_17_x86_64.manylinux2014_x86_64.whl
```
